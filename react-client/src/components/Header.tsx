...
const Header = () => {
  ...
  return (
    <Stack direction="row" spacing={3} justifyContent="space-between" alignItems="center" height="100px" sx={{ padding: "1rem 2rem 1rem 1 rem"}}>
      ...
      {token && (
        <Stack direction="row" spacing={4}>
          ...
          <Button sx={buttonStyle("/my-playlists")} onClick={() => handleNavigation("/my-playlists")}>My Playlists</Button> 
